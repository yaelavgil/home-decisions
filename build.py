...
BEDS_GUEST=[
 ...
 ("BG4","Kuala Style LIKET · גב מרופד בד אריג",6188,
  "https://kualastyle.com/products/liket?variant=47333292376219",
  "https://kualastyle.com/cdn/shop/files/210001.001.jpg?v=1760204959",
  ["הכי יוקרתית","ראש מיטה מרופד"],
  "האופציה היוקרתית ביותר מבין ארבעת המועמדות — משמעותית יקרה יותר, אבל עם נוכחות חזותית שהשלוש האחרות לא מציעות: ראש מיטה מרופד וגבוה (105 ס״מ) בשילוב עץ\n⭐ פיצ'ר מיוחד: 8 מידות זמינות (120×190 עד 200×200) ו-2 גוונים (טבעי/אגוז) — הכי גמישה מבין המועמדות אם רוצים לדייק מידה בדיוק\n✔ יש: תוצרת ישראל, 12 תשלומים ללא ריבית\n✘ אין: ארגז מצעים · משמעותית יקרה מהאחרות לחדר שאינו בשימוש יומיומי\n📐 מזרן 160×190 (בקישור זה — ניתן לבחור מידה אחרת בעמוד) · תוספת מסגרת 12 ס״מ רוחב / 13 ס״מ אורך · גובה בסיס 33 ס״מ · גובה ראש מיטה 105 ס״מ\n💰 ₪6,188 במבצע (רגיל ₪8,250)"),
]
for k in BEDS_GUEST:

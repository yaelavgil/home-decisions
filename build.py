...
# --- Single/toddler bed for Lily (age 2-6) — boutique/designer picks, verified 12.9.2026 ---
BEDS_LILY=[
 ("BL1","VIPACK Dallas Montessori · מיטת יחיד לבנה",1222,
  "https://homage-design.co.il/products/mytt-ykhyd-dls-mvntsvry-lbn",
  "https://homage-design.co.il/cdn/shop/files/DAKB9014_ZP_b830.jpg",
  ["🥇 מקום 1","מצב רצפה מונטסורי","🛏️ מיטת חבר"],
  "🥇 מקום 1 — האיזון הטוב ביותר בין בטיחות (מעקה מובנה + אפשרות הורדה לגובה רצפה במצב מונטסורי), מחיר משתלם משמעותית, ועיצוב סקנדינבי נקי מבוטיק בלגי (לא רשת המונית)\n⭐ פיצ'ר מיוחד: ניתן לשדרג בהמשך לגג (מיטת בית) ומיטת חבר נשלפת מתחת, בלי להחליף את המיטה עצמה\n✔ יש: עץ אורן מלא, גימור לכה לבנה, 5 שנות אחריות, תו תקן ישראלי ואירופאי\n✘ אין: מזרן כלול (מתווסף בנפרד, כ-₪460–1,110)\n📐 מזרן 90×200 (או 90×190) · מסגרת חוץ 210×97×66 ס״מ\n💰 ₪1,222 במבצע חגים (רגיל ₪1,490, בתוקף עד 24.9.2026)"),
 ("BL2","Kidikids Paris Montessori · מיטת יחיד",2389,
  "https://www.kidikids.co.il/product/מיטת-יחיד-ילדים-מונטסורית-מעץ-מלא-דגם-פ",
  "https://www.kidikids.co.il/wp-content/uploads/2024/09/10778-40.jpeg",
  ["🥈 מקום 2","הכי נמוכה ובטוחה"],
  "🥈 מקום 2 — הבחירה הבטוחה ביותר לגיל הרך: המיטה הנמוכה ביותר מבין המועמדות (18 ס״מ בלבד מהרצפה) — סיכון נפילה כמעט אפסי\n⭐ פיצ'ר מיוחד: מלווה את הילד מגיל שנה וחצי עד גיל בית ספר — מדלגים לגמרי על מיטת מעבר\n✔ יש: מעקה קדמי ייעודי לילדים (נשלף) עם פתח צר לעלייה/ירידה עצמאית ובטוחה, קצוות מעוגלים\n✘ אין: רגליים/מרווח מהרצפה — פחות נוח לניקוי מתחת למיטה\n📐 מזרן 90×190 · גובה מעקה 50 ס״מ · 💰 ₪2,389"),
 ("BL3","RANCO Emma · מיטת עץ ליבנה",2046,
  "https://ranco.co.il/product/mita-etz-emma/",
  "https://ranco.co.il/wp-content/uploads/2026/05/mitat-emma-ets-livneh-1200x1200.jpg",
  ["🥉 מקום 3","הכי בוטיקי"],
  "🥉 מקום 3 — העיצוב הכי \"בוטיקי\" ומעוצב מבין השלושה, ליבנה מלא בייצור ישראלי, למי שהאסתטיקה הסקנדינבית-יפנית היא שיקול מרכזי\n⭐ פיצ'ר מיוחד: זמינה במגוון רחב של מידות (190/80 עד 200/140) — אותו עיצוב יכול ללוות גם לגיל נוער\n✔ יש: פרופיל נמוך (22 ס״מ מהרצפה), דפנות צד מוגבהות (29 ס״מ) לתחושת עטיפה\n✘ אין: מעקה בטיחות מלא בתקן קלאסי — כדאי לשקול תוספת מעקה בתחילת גיל 2\n📐 מזרן 90×190 (הזמנה עד 200×140) · מידות חוץ 198×95 ס״מ · 💰 ₪2,046 (מ-₪2,200)"),
 ("BL4","Yashas Wood יאנג · הזולה מכולן",1210,
  "https://yashas-wood.co.il/product/מיטת-יאנג",
  "https://yashas-wood.co.il/wp-content/uploads/2023/04/מיטת-יאנג-799x1065.jpg",
  ["הכי זולה","גובה 23 ס״מ","🛏️ מיטת חבר"],
  "המחיר הזול ביותר מבין כל מועמדות יאשס-ווד (מיטת מעבר 140×70)\n⭐ פיצ'ר מיוחד: גובה מהרצפה מצוין במפורש — 23 ס״מ (רוב הדגמים האחרים לא מפרטים) · ניתן לערום מיטה על גבי השנייה לחיסכון במקום\n✔ יש: עץ ליבנה + פורמייקה, אפשרות שדרוג ליחיד/וחצי\n✘ אין: מעקה נשלף לא כלול (+₪208), מזרן לא כלול\n📐 מעבר 140×70 (ניתן להגדיל ליחיד 190×90 +₪500 או וחצי 190×120 +₪999) · 💰 ₪1,210"),
 ("BL5","Yashas Wood מיטה מונטסורית נמוכה — בסיס",1429,
  "https://yashas-wood.co.il/product/מיטה-מונטסורית-נמוכה",
  "https://yashas-wood.co.il/wp-content/uploads/2025/03/מיטה-מונטסורית-נמוכה-900x886.jpg",
  ["דגם בסיסי","3 אפשרויות פתח","🛏️ מיטת חבר"],
  "הדגם הבסיסי והזול ביותר מבין דגמי ה\"נמוכה\" של יאשס-ווד\n⭐ פיצ'ר מיוחד: עיצוב נקי ונעים לעין, גמיש עם 3 אפשרויות פתח (ימין/מלא/שמאל)\n✔ יש: עץ ליבנה + פורמייקה, טבעי/לבן/חשוף לבחירה\n✘ אין: מזרן ומעקה נשלף אינם כלולים\n📐 מעבר 140×70 (ניתן להגדיל ליחיד/וחצי) · 💰 ₪1,429"),
 ("BL6","Yashas Wood נינה · מעקות משני הצדדים",1759,
  "https://yashas-wood.co.il/product/מיטה-מונטסורית-נמוכה-דגם-נינה",
  "https://yashas-wood.co.il/wp-content/uploads/2026/03/מיטת-מעבר-דגם-נינה.jpg",
  ["מעקה בשני הצדדים","מק״ט YSH0748","🛏️ מיטת חבר"],
  "המעקות המובנים משני צידי המיטה (לא רק אחד) הופכים אותה למתאימה גם לילדים קטנים יותר\n⭐ פיצ'ר מיוחד: אפשרות ל\"מיטת מעבר\" קטנה (140×70) שלא קיימת בכל הדגמים\n✔ יש: עץ ליבנה + פורמייקה, טבעי/לבן/חשוף\n✘ אין: מזרן לא כלול, יש לבחור בנפרד ולשלם תוספת\n📐 מעבר 140×70 (ניתן להגדיל) · 💰 ₪1,759"),
 ("BL7","Yashas Wood נועה · בחירת כיוון פתיחה",1704,
  "https://yashas-wood.co.il/product/מיטה-מונטסורית-דגם-נועה",
  "https://yashas-wood.co.il/wp-content/uploads/2023/05/מיטה-מונטיסורית-דגם-נועה.jpg",
  ["מק״ט YSH0205","3 כיווני פתיחה","🛏️ מיטת חבר"],
  "בחירת כיוון פתיחה (ימין/מלא/שמאל) נותנת גמישות בסידור החדר\n⭐ פיצ'ר מיוחד: אפשרות שדרוג למיטת חבר או אחסון מתחת למיטה\n✔ יש: עץ ליבנה + פורמייקה, טבעי/לבן/חשוף\n✘ אין: \"המזרון אינו כלול\" — מצוין במפורש בעמוד המוצר\n📐 מעבר 140×70 (ניתן להגדיל ליחיד/וחצי) · 💰 ₪1,704"),
 ("BL8","Yashas Wood שני · מתאימה למזרן יחיד סטנדרטי",2089,
  "https://yashas-wood.co.il/product/מיטת-מונטיסורית-דגם-שני",
  "https://yashas-wood.co.il/wp-content/uploads/2023/03/מיטת-שני-1-900x675.jpg",
  ["היקרה מכולן","190×90 יחיד","🛏️ מיטת חבר"],
  "היקרה ביותר מבין דגמי יאשס-ווד שנבדקו, אבל מתאימה ישירות למזרן יחיד סטנדרטי 190×90\n⭐ פיצ'ר מיוחד: מוצגת תחת קטגוריית \"מיטות ילדים ונוער\" — עשויה להתאים לטווח גילאים רחב יותר\n✘ אין: מעקה המיטה אינו כלול במחיר (מצוין במפורש) · אין אפשרות גודל \"וחצי\" (190×120) בדגם זה\n📐 מעבר 140×70 (בסיס) / יחיד 190×90 +₪500 · 💰 ₪2,089"),
 ("BL9","Yashas Wood מוריה · פינות מעוגלות",1847,
  "https://yashas-wood.co.il/product/מיטה-מונטסורית-דגם-מוריה",
  "https://yashas-wood.co.il/wp-content/uploads/2026/03/מיטת-דגם-מאיה.jpg",
  ["פינות בטיחותיות","⚠️ לוודא תמונה","🛏️ מיטת חבר"],
  "פינות מעוגלות ובטיחותיות + ראש מיטה מוגבה מעט\n⚠️ שימו לב: תמונת המוצר בעמוד זה טעונה מקובץ בשם \"מאיה\" (לא \"מוריה\") — כנראה ערבוב תמונות אצל הספק עצמו. כדאי לוודא מול יאשס-ווד לפני הזמנה איזה עיצוב מדויק מקבלים\n⭐ פיצ'ר מיוחד: אפשרות הוספת מיטת חבר/אחסון מתחת\n📐 מעבר 140×70 (ניתן להגדיל ליחיד/וחצי) · 💰 ₪1,847"),
 ("BL10","Yashas Wood מאיה · זהה למוריה בעיצוב",1847,
  "https://yashas-wood.co.il/product/מיטה-מונטסורית-דגם-מאיה",
  "https://yashas-wood.co.il/wp-content/uploads/2026/03/מיטת-מאיה.jpg",
  ["זהה למוריה","תמונה תואמת","🛏️ מיטת חבר"],
  "זהה בעיצובה לדגם מוריה (פינות מעוגלות, ראש מיטה מוגבה מעט) באותו מחיר בסיס בדיוק\n⭐ פיצ'ר מיוחד: כאן שם קובץ התמונה כן תואם נכון לשם הדגם (בניגוד למוריה) — כדאי להשוות ישירות מול הספק אם יש הבדל אמיתי בין השניים\n✘ אין: מעקה לא כלול כברירת מחדל\n📐 מעבר 140×70 (ניתן להגדיל ליחיד/וחצי) · 💰 ₪1,847"),
 ("BL11","Uzliwood ליאה · ספריית תצוגה מובנית",1100,
  "https://www.uzliwood.co.il/items/9539579-מיטה-מונטסורית-דגם-ליאה-",
  "https://d3m9l0v76dty0.cloudfront.net/system/photos/30217536/large/2e97719cccf1eb620545fc68cfb67fb9.jpg",
  ["במבצע (מ-1,300)","ספרייה מובנית","🛏️ מיטת חבר"],
  "במבצע — ₪1,100 במקום ₪1,300\n⭐ פיצ'ר מיוחד: ספריית תצוגה מובנית בדופן המיטה (לספר/בובה/בקבוק מים) + רגליים בגובה 17 ס״מ שמתאימות למעבר שואב אבק רובוטי\n✔ יש: עץ ליבנה מלא, פורמייקה לבנה או לכה שקופה\n✘ אין: מעקה בטיחות כברירת מחדל (נשלף בתוספת ₪150) · מזרן ומשלוח+הרכבה (₪450) בנפרד\n📐 מעבר 130×70 (ניתן להגדיל ל-160×80/190×90/190×120)"),
 ("BL12","Uzliwood אמי · מעקה 360° מובנה",1190,
  "https://www.uzliwood.co.il/items/7782719-מיטת-אמי",
  "https://d3m9l0v76dty0.cloudfront.net/system/photos/16376621/large/49b56d4b85b0763dec03d667e4f4df10.jpeg",
  ["במבצע (מ-1,500)","מעקה 360° כלול","🛏️ מיטת חבר"],
  "במבצע — ₪1,190 במקום ₪1,500\n⭐ פיצ'ר מיוחד: מעקות היקפיים קבועים ב-360 מעלות מובנים במחיר הבסיס (לא תוספת) + פתח כניסה קדמי נגיש (80 ס״מ)\n✔ יש: עץ ליבנה מלא, שיוף ידני, פינות מעוגלות\n✘ אין: שדרוג לגודל יחיד/וחצי עולה ₪800–1,500 נוספים · מזרן ומשלוח+הרכבה בנפרד\n📐 מעבר 130×70 (ניתן להגדיל, כולל מידה מותאמת אישית)"),
 ("BL13","Uzliwood מיטה נורדית · הזולה בכל הרשימה",699,
  "https://www.uzliwood.co.il/items/6551048-מיטה-נורדית",
  "https://d3m9l0v76dty0.cloudfront.net/system/photos/20312533/large/3fc27fd23791912adb4ffaa26c929b50.jpg",
  ["הכי זולה בהחלט","20 ס״מ מהרצפה"],
  "במבצע — ₪699 במקום ₪1,200. הזולה ביותר מכל 14 האופציות שנבדקו\n⭐ פיצ'ר מיוחד: המעקה (כשמוזמן) ניתן להסרה בקלות כשהילד גדל — אותה מיטה \"גדלה\" איתו\n✔ יש: מיטת רצפה נמוכה במיוחד (20 ס״מ) לעצמאות מלאה בכניסה ויציאה, עץ מלא וגימור לכה בטיחותית\n✘ אין: מעקה מובנה (נשלף בתוספת ₪150) · זמן אספקה ארוך יחסית (כ-40 ימי עסקים)\n📐 מעבר 134×74 (ניתן להגדיל ל-160×80/190×90/190×120)"),
 ("BL14","Ponponi מיטת חבר · יחיד + מיטת חבר",3349,
  "https://www.ponponi.co.il/product/מיטת-חבר/",
  "https://www.ponponi.co.il/wp-content/uploads/2023/07/bedliam01.jpg",
  ["כולל מיטת חבר","190×90 + 170×90","🛏️ מיטת חבר"],
  "מיטת יחיד עם מיטת חבר נשלפת כלולה במחיר הבסיס — פתרון ללינות/אירוח לחברה\n⭐ פיצ'ר מיוחד: ניתן להמיר את מיטת החבר לארגז אחסון עם פלטה מלאה (+₪199) במקום קרשים\n✔ יש: עץ בירץ איכותי, ציפוי פורמייקה בגוון עץ\n✘ אין: אף מזרן לא כלול (יחיד ₪849, חבר ₪570) · הובלה+הרכבה בנפרד · אספקה 30–45 ימי עסקים\n📐 יחיד למזרן 190×90 · חבר למזרן 170×90 · גובה ראש מיטה 73 ס״מ"),
 ("BL15","Ponponi אמה · עיצוב בוהו שיק",3349,
  "https://www.ponponi.co.il/product/bed05/",
  "https://www.ponponi.co.il/wp-content/uploads/2023/08/camaemma-3L.jpg",
  ["בוהו שיק","ראש מיטה נמוך","🛏️ מיטת חבר"],
  "מבנה זהה ל\"מיטת חבר\" (יחיד + חבר נשלפת) אבל בעיצוב \"בוהו שיק\" שונה חזותית — ראש מיטה נמוך יחסית (60 ס״מ)\n⭐ פיצ'ר מיוחד: מיטת חבר כלולה במחיר הבסיס, אפשרות המרה לארגז אחסון (+₪199)\n✔ יש: עץ בירץ, ציפוי פורמייקה עץ\n✘ אין: מזרנים לא כלולים (יחיד ₪849, חבר ₪570) · אין מעקה מובנה (נשלף +₪249) · הובלה+הרכבה בנפרד\n📐 יחיד למזרן 190×90 · חבר למזרן 170×90 · גובה ראש מיטה 60 ס״מ"),
 ("BL16","Ponponi Charlie · מיטה מגודרת נמוכה",2100,
  "https://www.ponponi.co.il/product/kids-bed-charlie/",
  "https://www.ponponi.co.il/wp-content/uploads/2026/07/bed-charlie.jpg",
  ["הזולה בפונפוני","מגודרת, ללא חבר"],
  "המחיר הבסיסי הזול ביותר מבין ארבעת דגמי פונפוני שנבדקו, ללא צורך במיטת חבר/אחסון נלווים\n⭐ פיצ'ר מיוחד: מעקות הגנה מובנים (\"מגודרת\") בעיצוב נמוך המאפשר כניסה/יציאה עצמאית\n✔ יש: עץ ליבנה בירץ, פורמייקה בגוון עץ טבעי או לבן לבחירה\n✘ אין: מזרן לא כלול · הובלה והרכבה בתשלום נפרד · אספקה 30–45 ימי עסקים\n📐 מזרן 190×90 · מידות חוץ 195×95 ס״מ"),
 ("BL17","Ponponi ליאם · יחיד + מיטת חבר (מק״ט BED-LIAM)",3349,
  "https://www.ponponi.co.il/product/bed04/",
  "https://www.ponponi.co.il/wp-content/uploads/2023/07/camalaiam01-low2.jpg",
  ["⚠️ דומה ל-BL14","כולל מיטת חבר","🛏️ מיטת חבר"],
  "⚠️ שימו לב: כמעט זהה במפרט, במחיר ובמק״ט (BED-LIAM מול BED-LIAM-KIDS) ל\"מיטת חבר\" למעלה באותו אתר, עם תמונה ראשית שונה בלבד — ייתכן ששני עמודי המוצר מייצגים את אותו דגם פיזי. כדאי לוודא מול פונפוני לפני שמזמינים כאילו מדובר בשתי אפשרויות שונות\n✔ יש: מיטת חבר נשלפת כלולה, אפשרות המרה לארגז אחסון\n✘ אין: מזרנים לא כלולים · הובלה+הרכבה בתשלום נפרד\n📐 יחיד למזרן 190×90 · חבר למזרן 170×90 · גובה ראש מיטה 73 ס״מ"),
 ("BL18","Tushaloola Twins · מיטת חבר נפתחת לגובה זהה",2500,
  "https://tushaloola.co.il/product/twins-%d7%98%d7%91%d7%a2%d7%99-%d7%9e%d7%99%d7%98%d7%aa-%d7%97%d7%91%d7%a8-%d7%a0%d7%a4%d7%aa%d7%97%d7%aa-%d7%91%d7%92%d7%95%d7%91%d7%94-%d7%96%d7%94%d7%94/",
  "https://tushaloola.co.il/wp-content/uploads/2025/07/1000269991.png",
  ["🛏️ מיטת חבר","🛏️ נפתחת לגובה זהה"],
  "מיטת חבר שנפתחת ממש לאותו הגובה של המיטה הראשית (לא מיטה נמוכה שנשלפת מתחת) — כשהיא סגורה נראית כמיטה אחת עם שני מזרנים זה על זה, וכשפותחים אותה היא נפרדת לשתי מיטות יחיד זהות בגובהן, זו לצד זו\n⭐ פיצ'ר מיוחד: הצהרה מפורשת באתר \"מיטת חבר נפתחת לגובה זהה\" — לא שיווקי סתמי, יש הסבר טכני מדויק למנגנון\n✔ יש: עץ ליבנה בגימור טבעי (יש גם גרסה בגימור לבן, אותו מחיר), אפשרות שדרוג עם ארגז אחסון, מעקה ומזרנים\n✘ אין: מזרנים כלולים כברירת מחדל (אלוורה +₪450 או ויסקו +₪650, לכל מיטה בנפרד) · מעקה לא כלול (+₪150–250)\n📐 מזרן סטנדרטי 190×80 (או מוגדל 190×90 +₪150) · 💰 ₪2,500 בסיס"),
 ("BL19","Babysleep קורל · נפתחת למיטה זוגית רחבה",2550,
  "https://babysleep.shop/product/%D7%9E%D7%99%D7%98%D7%94-%D7%93%D7%92%D7%9D-%D7%A7%D7%95%D7%A8%D7%9C-%D7%A0%D7%A4%D7%AA%D7%97%D7%AA-%D7%9C%D7%92%D7%95%D7%91%D7%94-%D7%96%D7%94%D7%94/",
...
BEDS_GUEST=[
 ("BG1","Kuala Style YULONG · בסיס מיטה אלון מלא",3338,
  "https://kualastyle.com/products/yulong",
  "https://kualastyle.com/cdn/shop/products/limor-2.jpg?v=1760204940",
  ["🥇 מקום 1","עיצוב סקנדינבי, אלון מלא"],
  "🥇 מקום 1 — האיזון הכי טוב בין עיצוב סקנדינבי אמיתי, איכות עץ אלון מלא (לא סיבית/פורניר) ומחיר הוגן ל\"מיטה שנייה\" שלא בשימוש יומיומי\n⭐ פיצ'ר מיוחד: קווים מעוגלים והרמוניים, זמינה גם ב-140×190 ו-180×200 לגמישות עתידית\n✔ יש: תשלומים ללא ריבית, גוונים טבעי/לבן/מושחר\n✘ אין: ראש מיטה מורם (מראה נמוך וצף — פחות נוח להישען לקריאה), מזרן, משלוח חינם\n📐 מזרן 160×200 · מסגרת חוץ כ-180×220 · גובה רגליים 27 ס״מ\n💰 ₪3,338 במבצע (רגיל ₪4,450)"),
 ("BG2","Kuala Style ASPEN · מיטה כפרית גוון אפור ווש",3263,
  "https://kualastyle.com/products/aspen",
  "https://kualastyle.com/cdn/shop/products/178_ASPEN-6563072016539.jpg?v=1760344922",
  ["🥈 מקום 2","עם ראש מיטה"],
  "🥈 מקום 2 — חלופה מצוינת עם ראש מיטה אמיתי (90 ס״מ, נוח להישען) ונוכחות חזותית טובה יותר לחדר, באותו טווח מחיר בדיוק\n⭐ פיצ'ר מיוחד: גימור \"ווש\" אפרפר כפרי-מודרני שעמיד מבחינה עיצובית — לא מתיישן כמו בד צבעוני\n✔ יש: תוצרת ישראל, אחריות שנה\n✘ אין: ארגז מצעים, משלוח חינם\n📐 מזרן 160×200 · מסגרת חוץ כ-169×210 · גובה ראש מיטה 90 ס״מ · גובה רגליים 20 ס״מ\n💰 ₪3,263 במבצע (רגיל ₪4,350)"),
 ("BG3","רהיטי טבע WINGS · מיטה זוגית אלון מלא",5653,
  "https://naturefurniture.co.il/product/solid-oak-wood-double-bed-wings/",
  "https://naturefurniture.co.il/wp-content/uploads/2018/07/WINGS_02_frontal.jpg",
  ["🥉 מקום 3","הכי בוטיקי"],
  "🥉 מקום 3 — הבחירה הכי \"בוטיק/מעצבים\" מבין השלוש: בוטיק ישראלי מומחה לריהוט סקנדינבי (לא רשת), עם חנויות פיזיות בבני ברק ונתניה לבדיקה לפני קנייה\n⭐ פיצ'ר מיוחד: עיצוב \"כנפיים\" חתימה של המותג — נראה כמו רהיט מעוצב, לא מיטה גנרית\n✔ יש: עץ אלון מלא איכותי, זמינה גם עד 200×200\n✘ אין: ארגז מצעים · המחיר הגבוה משמעותית מהשתיים האחרות לחדר שאינו בשימוש יומיומי\n📐 מזרן עד 200×200 · גובה ראש מיטה 80 ס״מ · גובה מהרצפה 20 ס״מ\n💰 ₪5,653 במבצע (רגיל ₪5,950)"),
]
for k in BEDS_GUEST:
...
.plannerlink:hover{background:var(--brass);color:#fff}
...
.thumb img{width:100%;height:100%;object-fit:contain;padding:6px;display:block;transition:transform .5s cubic-bezier(.2,.7,.2,1)}
...
.addImgPreview img{width:100%;height:100%;object-fit:contain}
...
.cartrow img{background:transparent;padding:2px}
...
<header>
  <div class="hrow">
    ...
    <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
      <a href="planner/" class="plannerlink">🛒 מתכנן קנייה חכם</a>
      <a href="entrance-cabinet/" class="plannerlink">🚪 גוונים לארון כניסה</a>
...
function cartRow(i,q,note,isMaybe,editable){
  const media=i.type==='color'?`<span class="cthumb" style="background:${i.hex}"></span>`:(i.img?`<img src="${i.img}" alt="">`:`<span class="cthumb"></span>`);
...
function fbPoll(){ fetch(`${DB}/picks.json`).then(r=>r.json()).then(d=>{
  ...
  // once the server has its own "ordered" value for an id, this device's local
  // optimistic override (from the moment of clicking, before the round-trip
  // confirmed) has served its purpose — drop it, or it would shadow the
...
function renderOrder(ids){
  ...
  const rows=items.map(i=>{ if(i.price!=null&&!i.ordered)total+=i.price; else if(i.price==null) missing++;
    ...
    return `<div class="orow">${i.img?`<img src="${i.img}" alt="">`:''}<div class="oi"><div class="on2">${i.name}${ord}</div>${i.link?`<a href="${i.link}" target="_blank" rel="noopener">לעמוד המוצר בחנות</a>`:''}${i.zap?` · <a href="${i.zap}" target="_blank" rel="noopener">השוואת מחירים בזאפ</a>`:''}</div><div class="op">${i.price!=null?nis(i.price):''}</div></div>`; }).join('');
